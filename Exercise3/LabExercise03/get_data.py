...
for step in range(opt.data_steps):
    ...
    # save data & label
    pob_rgb2gray = rgb2gray(state.pob)

    # print("Shape of pob_rgb2gray: {}".format(pob_rgb2gray.shape))

    flattened_pob_rgb2gray = pob_rgb2gray.flatten()[0:opt.state_siz]

    # print("Shape of flattened_pob_rgb2gray {}".format(flattened_pob_rgb2gray.shape))
    # print("State size: {}".format(opt.state_siz))

    states[step, 0:flattened_pob_rgb2gray.shape[0]] = flattened_pob_rgb2gray
